...
def get_list():
    ...
    names = xml.xpath(
        '//div[@class="thumbnails activity"]/a/div[2]/div[2]//text()')
...
def get_wiki_info(artist):
    ...
    try:
        ...
        country = "".join(xml.xpath(
            '//table[contains(@class,"infobox")]//tr[th[contains(text(),"國家") or contains(text(),"來源")]]/td//text()'))
        ...
        classify = "、".join(xml.xpath(
            '//table[contains(@class,"infobox")]//tr[th[contains(text(),"類型")]]//a/text()'))
